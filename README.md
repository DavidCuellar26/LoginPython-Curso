...
Las distribuciones de Git para sistemas Linux y POSIX están disponibles en el sitio web oficial de Git SCM.
...
Realizar cambios
Enviar Pull Request
Discutir los cambios propuestos y realizar más commits si es necesario
Fusionar rama feature en master
Glosario
